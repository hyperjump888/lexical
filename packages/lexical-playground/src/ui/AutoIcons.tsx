...
export default function AutoIcons() {
  ...
  const [tbody, setTbody] = useState<JSX.Element>(<tbody />);
  ...
  const onChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setTbody(dataTbody(icons));
  };

  const dataTbody = (arr: string[]) => {
    return (
      <tbody>
        <tr>
          {arr.map((item) => {
          ...
          <thead>
            <tr>
              <td className="text-center">
                <Button className="btn-previous" onClick={onPrev}>
                  Prev
                </Button>
              </td>
              <td className="text-center">
                <span className="page-count">... of Pages</span>
              </td>
              <td className="text-center">
                <Button className="btn-next disabled" onClick={onNext}>
                  Next
                </Button>
              </td>
            </tr>
